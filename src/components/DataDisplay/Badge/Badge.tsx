...
const VARIANT_STYLES: Record<BadgeVariant, CSSProperties> = {
  ...
  // ── Users page ───────────────────────────────────
  primary: { background: 'rgba(26,95,180,0.10)',  color: '#1A5FB4' },
  info:    { background: 'rgba(26,95,180,0.10)',  color: '#1A5FB4' },
  purple:  { background: 'rgba(26,95,180,0.10)', color: '#1A5FB4' },
  ...
  'priority-basse':   { background: 'linear-gradient(135deg, #1A5FB4 0%, #0F4A9E 100%)', color: '#fff' },
  'ticket-nouveau':   { background: 'linear-gradient(135deg, #F4B400 0%, #FF8F00 100%)', color: '#fff' },
  'ticket-encours':   { background: 'linear-gradient(135deg, #1A5FB4 0%, #1E40AF 100%)', color: '#fff' },
  'ticket-resolu':    { background: 'linear-gradient(135deg, #1A5FB4 0%, #0F4A9E 100%)', color: '#fff' },
};
