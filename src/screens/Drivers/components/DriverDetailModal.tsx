...
function LightboxThumb({ url, alt, active, onClick }: { url: string; alt: string; active: boolean; onClick: () => void }) {
  ...
  return (
    <button type="button" onClick={onClick} style={{
      width: 52, height: 38, border: `2px solid ${active ? '#00A86B' : 'transparent'}`,
...
function PhotoCard({
  ...
  return (
    <div style={{ borderRadius: 10, overflow: 'hidden', border: '1.5px solid #E5E7EB', background: '#F9FAFB' }}>
      ...
      >
        {loadingImg ? (
          <div style={{ width: 26, height: 26, borderRadius: '50%', border: '3px solid #E5E7EB', borderTopColor: '#00A86B', animation: 'spin .8s linear infinite' }} />
        ) : hasImg ? (
          <>
    ...
    <div style={{ borderRadius: 10, overflow: 'hidden', border: '1.5px solid #E5E7EB', background: '#F9FAFB' }}>
      ...
      >
        {(externalLoading && !url) || (loadingImg && !isFilePdf) ? (
          <div style={{ textAlign: 'center' }}>
            <div style={{ width: 26, height: 26, borderRadius: '50%', margin: '0 auto 6px', border: '3px solid #E5E7EB', borderTopColor: '#00A86B', animation: 'spin .8s linear infinite' }} />
    ...
    <>
      ...
      <DetailModal title="Détail Conducteur" onClose={onClose} accentColor="#00A86B">
        ...
        <DetailSection title="Éligibilité Véhicule">
              ...
              return (
                <label
                  ...
                  style={{
                    ...
                    background: isChecked ? 'rgba(0,168,107,0.06)' : '#F9FAFB',
                    border: `1.5px solid ${isChecked ? '#00A86B' : '#E5E7EB'}`, transition: 'all .15s',
                  }}
                >
                  <div style={{
                    width: 18, height: 18, borderRadius: 5, flexShrink: 0, marginTop: 1,
                    border: `2px solid ${isChecked ? '#00A86B' : '#D1D5DB'}`,
                    background: isChecked ? '#00A86B' : 'white',
                    display: 'flex', alignItems: 'center', justifyContent: 'center',
                  }}>
          ...
          {isPending && (
            <p style={{ fontSize: 11, color: allChecked ? '#00A86B' : '#F59E0B', marginTop: 10 }}>
              {allChecked
          ...
          <div style={{ display: 'flex', gap: 10, marginTop: 8, borderTop: '1px solid #F3F4F6', paddingTop: 16 }}>
            ...
            <button
              ...
              style={{
                ...
                background: allChecked ? '#00A86B' : '#D1FAE5',
