  ...
  const kpis = [
    {
      ...
      iconBg: '#D6E8F7', iconColor: '#1A5FB4',
      icon: <AppIcon icon={Users} size={24} color="#1A5FB4" />,
    },
    {
      ...
      badgeVariant: 'success' as const,
      iconBg: '#DCFCE7', iconColor: '#1A5FB4',
      icon: <AppIcon icon={Car} size={24} color="#1A5FB4" />,
    },
    {
    ...
    },
    {
      ...
      iconBg: '#DCFCE7', iconColor: '#1A5FB4',
      icon: <AppIcon icon={Star} size={24} color="#1A5FB4" />,
    },
  ];
