...
const CARDS: {
  ...
  },
  {
    ...
    Icon: Calendar,
    iconBg: 'rgba(249,115,22,0.10)', iconColor: '#F97316',
    badge: (m) => String(m.bookings_month),
  },
  {
    key: 'cancellation_rate', label: 'Taux Annulation',
    Icon: TrendingDown,
    iconBg: 'rgba(229,57,53,0.10)', iconColor: '#E53935',
  ...
  },
  {
    ...
    Icon: AlertCircle,
    iconBg: 'rgba(244,180,0,0.10)', iconColor: '#F4B400',
    badge: (m) => String(m.incidents),
  },
  {
    key: 'avg_rating', label: 'Note Moyenne',
    Icon: Star,
    iconBg: 'rgba(34,197,94,0.10)', iconColor: '#22C55E',
    badge: (m) => m.avg_rating != null ? String(m.avg_rating) : '—',
  },
  {
    key: 'suspended', label: 'Suspendus',
    Icon: UserX,
    iconBg: 'rgba(107,114,128,0.10)', iconColor: '#6B7280',
